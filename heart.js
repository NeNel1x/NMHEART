...
var init = function () {
    ...
    var scaleFactorX = 480; // Збільшив ширину вдвічі
    var scaleFactorY = 40;
    var centerX = width / 2;
    ...
    var pulse = function (kx, ky) {
        for (i = 0; i < pointsOrigin.length; i++) {
            targetPoints[i] = [
                kx * (pointsOrigin[i][0] - centerX) + centerX,
                ky * (pointsOrigin[i][1] - centerY) + centerY
            ];
        }
    };
    ...
    for (i = 0; i < heartPointsCount; i++) {
        ...
        for (var k = 0; k < 20; k++) e[i].trace[k] = { x: x, y: y };
    }
